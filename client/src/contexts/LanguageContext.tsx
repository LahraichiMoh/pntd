...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    "hero.quote": " \"فالتكنولوجيا الرقمية تشكل بالفعل، تحولا بنيويا في مقاربتنا للعالم الذي يحيط بنا، إذ تسمح بتطوير\nأنماط إنتاجية واستهلاكية جديدة، من شأنها أن تخلق المزيد من مناصب الشغل، وأن تشكل مصدرا للرفع من فرص الإستثمار\".",
