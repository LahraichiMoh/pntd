...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "hero.quote": "« La technologie numérique constitue véritablement une transformation structurelle dans notre approche du monde qui nous entoure ; elle permet de développer de nouveaux modes de production et de consommation, susceptibles de créer davantage d’emplois et de constituer une source de renforcement des opportunités d’investissement. »",
    "hero.quote_author": "SA MAJESTÉ LE ROI MOHAMMED VI, QUE DIEU L'ASSISTE",
    ...
    "join.consent_publish": "Je consens à la publication de mes informations",
    "join.consent_publish_desc": "Autorise le PNTD à publier certaines informations (nom, profil, région) dans un annuaire public.",
  ...
  ar: {
    ...
    "hero.title_part2": "متقدم رقميا",
    "hero.quote": " \"فالتكنولوجيا الرقمية تشكل بالفعل، تحولا بنيويا في مقاربتنا للعالم الذي يحيط بنا، إذ تسمح بتطوير أنماط إنتاجية واستهلاكية جديدة، من شأنها أن تخلق المزيد من مناصب الشغل، وأن تشكل مصدرا للرفع من فرص الإستثمار\".",
    "hero.quote_author": "صاحب الجلالة الملك محمد السادس نصره الله",
    ...
    "join.consent_publish": "أوافق على نشر معلوماتي",
    "join.consent_publish_desc": "يسمح للبرنامج بنشر بعض المعلومات (الاسم، الملف، الجهة) ضمن دليل عمومي.",
  ...
  en: {
    ...
    "hero.quote": "“Digital technology is indeed a structural transformation in our approach to the world around us; it enables the development of new productive and consumption patterns that can create more jobs and become a source for increasing investment opportunities.”",
    "hero.quote_author": "HIS MAJESTY KING MOHAMMED VI, MAY GOD ASSIST HIM",
    ...
    "join.consent_publish": "I consent to publishing my information",
    "join.consent_publish_desc": "Allows PNTD to publish some information (name, profile, region) in a public directory.",
